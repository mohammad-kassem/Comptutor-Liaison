...
export default function TutorScreen({ route }) {
  ...
  useFocusEffect(
    React.useCallback(() => {
      getTutor(tutorId, setTutor, setIsLoading);
    }, [])
  );
            ...
            <View style={styles.imageContainer}>
              {tutor.profile_image ? (
                <Image
                  ...
                  source={{ uri: tutor.profile_image }}
                />
              ) : (
                <Image
                  style={styles.tutorProfile}
                ...
                <FullWidthButton
                  ...
                  onHandlePress={() =>
                    navigation.navigate("ChatStack", {
                      screen: "ChatScreen",
                      params: { reciever: tutor, isStudent: true },
                    })
                  }
                  icon="send"
                />
      ...
      {!isLoading && (
        <AbsolutePositionButtonContainer>
          <FullWidthButton
            ...
            onHandlePress={() => onHandlePress(tutor, navigation)}
            color="green"
          />
        </AbsolutePositionButtonContainer>
      )}
